...
namespace LatexRendererAPI.Controllers
{
    ...
    public class StarProjectController : ControllerBase
    {
        ...
        public IActionResult AddStarProject([FromBody] AddUserProjectDto dto)
        {
            ...
            var checkExist = dbContext.StarProjects.FirstOrDefault(v =>
                v.ProjectId == dto.ProjectId && v.EditorId == dto.EditorId
            );
            if (checkExist != null)
                return BadRequest();
            ...
            return Ok(new { totalStar, starProject.Id, });
        }
        ...
        public IActionResult DeleteStarProject([FromRoute] Guid id)
        {
            ...
            var totalStar = dbContext
                .StarProjects.Where(sp => sp.ProjectId == checkExist.ProjectId)
                .Count();

            return Ok(new { totalStar });
        }
    }
}
